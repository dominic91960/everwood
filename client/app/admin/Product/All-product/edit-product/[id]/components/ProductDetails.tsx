...
const ProductDetails = ({ 
  ...
  const handleInputChange = (field: string, value: string | boolean) => {
    ...
    if (field === 'price' || field === 'discountPrice') {
      const price = parseFloat(field === 'price' ? value as string : newData.price);
      const discountPrice = parseFloat(field === 'discountPrice' ? value as string : newData.discountPrice);
