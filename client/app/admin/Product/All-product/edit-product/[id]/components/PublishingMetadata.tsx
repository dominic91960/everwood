        ...
        <div className="space-y-4">
          <div>
            <select
              ...
              className="w-full px-3 py-3 rounded-lg border border-[#6E6E6E] focus:outline-none focus:ring-blue-500 focus:border-[#6E6E6E] text-white text-sm bg-black/30 backdrop-blur-[500px]"
            >
