...
interface AttributesProps {
  selectedAttributes: ISimpleProductPayloadAttribute[];
  attributeData: IProductAttribute[];
  onProductAttributeChange: (attributeData: ISimpleProductPayloadAttribute[]) => void;
}
...
const Attributes: React.FC<AttributesProps> = ({
  ...
  >(() => {
    ...
    selectedAttributes?.forEach((item) => {
      selected[item.attribute] = item.selectedVariations;
    });
    return selected;
  });
