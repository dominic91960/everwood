...
const PublishingMetadata = () => {
  return (
    <div className="space-y-4">
      {/* Publish Section */}
      <div className=" p-4 rounded-3xl border border-[#6E6E6E] bg-black/30 backdrop-blur-[500px]">
        <h3 className=" font-medium text-[#FFFFFF] text-[17px] mb-4">Publish</h3>
        <div className="space-y-4">
          <div>
            <select className="w-full px-3 py-3 rounded-lg border border-[#6E6E6E]  focus:outline-none  focus:ring-blue-500 focus:border-[#6E6E6E] text-white placeholder:text-sm text-sm  bg-black/30 backdrop-blur-[500px]" disabled>
      ...
      <div className="border border-[#6E6E6E] bg-black/30 backdrop-blur-[500px] p-4 rounded-3xl">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full px-3 text-sm py-3   border border-[#6E6E6E] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 placeholder:text-sm"
            readOnly
          />
          <div>
            <h4 className="text-lg font-medium text-white mb-3">All categories</h4>
            <div className="border border-[#6E6E6E]  p-4 rounded-lg">
      ...
      {/* <div className="border border-[#6E6E6E] bg-black/30 backdrop-blur-[500px] p-4 rounded-3xl">
        ...
        <div className="space-y-3">
          <input
            type="text"
            className="w-full px-3 py-3 text-sm  border border-[#6E6E6E] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 placeholder:text-sm"
            readOnly
          />
          <div>
      ...
      {/* <div className="border border-[#6E6E6E] bg-black/30 backdrop-blur-[500px] p-4 rounded-3xl">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              rows={3}
              className="w-full px-3  py-3 text-sm   border border-[#6E6E6E]  rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 placeholder:text-sm resize-none"
