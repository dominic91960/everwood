...
const Attributes: React.FC<AttributesProps> = ({ product }) => {
  return (
    <div>
      ...
      <div className="rounded-3xl border border-[#6E6E6E] bg-black/30 backdrop-blur-[500px] p-6 overflow-hidden">
            ...
            product.attributes.map((attr, index) => (
              <div key={attr.attribute._id}>
                ...
                <div className="relative">
                  <select
                    className="w-full px-4 py-3 rounded-lg border border-[#6E6E6E] bg-black/30 text-white appearance-none focus:outline-none focus:border-[#3B82F6] transition-colors"
                    disabled
                    value=""
                  >
