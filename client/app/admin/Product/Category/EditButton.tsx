  ...
  ({ identifier, buttonText, className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          identifier,
          "relative flex items-center bg-[#028EFC] text-white px-4 py-2 rounded-md shadow-md transition-all duration-300 ease-in hover:bg-[#5FA3B6] overflow-hidden xl:w-[200px] w-auto",
          className
        )}
