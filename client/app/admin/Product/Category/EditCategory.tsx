...
const EditCategory: React.FC<EditCategoryProps> = ({ onClose, category, onCategoryUpdated }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#00000033] flex items-center justify-center z-[10000]">
      <div className="relative w-full max-w-2xl rounded-3xl bg-black/20 border border-[#6E6E6E] backdrop-blur-[500px] p-6 shadow-lg z-[9999]">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border border-[#6E6E6E] p-3 text-sm bg-transparent text-white"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="mt-1 block w-full rounded-sm border border-[#6E6E6E] p-3 text-sm h-24 bg-transparent text-white"
