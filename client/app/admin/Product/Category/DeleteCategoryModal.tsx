...
const DeleteCategoryModal: React.FC<DeleteCategoryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-[#0000004D]/90 backdrop-blur-[500px] border border-[#6E6E6E] rounded-xl p-6 w-full max-w-md mx-4">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex gap-3">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="flex-1 px-4 py-2 border border-[#6E6E6E] text-[#94A3B8] rounded-lg hover:bg-[#6E6E6E]/20 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
