...
export default function AddBankAccountModal({
  ...
  return (
    <div className="bg-opacity-50 fixed inset-0 z-[9999] flex items-center justify-center bg-black/70">
      <div className="mx-4 w-full max-w-2xl rounded-xl border border-[#172D6D] bg-[#00000033]/30 p-6 backdrop-blur-[500px]">
        {/* Header */}
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="left-1 flex h-8 w-8 items-center justify-center rounded-full bg-[#172D6D] text-white transition-colors hover:bg-[#2a3f7a]"
          >
            <svg
              className="h-4 w-4"
              fill="none"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-[#172D6D] px-3 py-2 text-sm text-white placeholder:text-[#AEB9E1]/50 focus:border-[#028EFC] focus:outline-none"
                  readOnly={mode === "view"}
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none rounded-md border border-[#172D6D] px-3 py-2 text-sm text-white focus:border-[#028EFC] focus:outline-none"
                    disabled={mode === "view"}
                  >
