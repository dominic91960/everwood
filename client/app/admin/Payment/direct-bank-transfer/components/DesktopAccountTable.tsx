...
export default function DesktopAccountTable({
  ...
  return (
    <>
      <div className="hidden overflow-hidden rounded-xl border border-[#172D6D] lg:block">
        {/* Table header */}
        <div className="grid grid-cols-4 gap-3 border-b border-[#172D6D] px-4 py-3 text-sm text-[#AEB9E1]">
