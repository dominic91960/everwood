  ...
  ({ identifier, buttonText, className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          identifier,
          "relative flex items-center bg-[#70BDD1] text-white px-4 py-2 rounded-full shadow-md transition-all duration-300 ease-in hover:bg-[#5FA3B6] overflow-hidden xl:w-[200px] w-auto",
          className
        )}
