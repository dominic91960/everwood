...
function bookacall() {
  return (
    ...
    <div className='py-4 lg:py-0 hidden md:block'>
      <a href="https://calendar.app.google/2iiAARicQAcrX5m69" target="_blank" rel="noopener noreferrer" className="group  md:mb-0  lg:mb-4  bg-button text-white rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-opacity-90 inline-block">
