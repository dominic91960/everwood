...
const ShippingForm = () => {
  ...
  const {
    ...
    defaultValues: {
      firstName: user ? user.shippingInfo.firstName : "",
      lastName: user ? user.shippingInfo.lastName : "",
      tel: user ? user.shippingInfo.phoneNo : "",
      email: user ? user.shippingInfo.email : "",
      address: user ? user.shippingInfo.address : "",
      apartment: user ? user.shippingInfo.apartment : "",
      city: user ? user.shippingInfo.city : "",
      state: user ? user.shippingInfo.state : "",
      zip: user ? user.shippingInfo.zipCode : "",
    },
  });
  ...
  const onSubmit = async (data: ShippingType) => {
    try {
      ...
      await api.patch(`/user/${user._id}?field=shippingInfo`, { shippingInfo });
      setUser({ ...user, shippingInfo });
