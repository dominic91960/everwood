...
const BillingForm = () => {
  ...
  const {
    ...
    defaultValues: {
      firstName: user ? user.billingInfo.firstName : "",
      lastName: user ? user.billingInfo.lastName : "",
      tel: user ? user.billingInfo.phoneNo : "",
      email: user ? user.billingInfo.email : "",
      address: user ? user.billingInfo.address : "",
      apartment: user ? user.billingInfo.apartment : "",
      city: user ? user.billingInfo.city : "",
      state: user ? user.billingInfo.state : "",
      zip: user ? user.billingInfo.zipCode : "",
    },
  });
  ...
  const onSubmit = async (data: ShippingType) => {
    try {
      ...
      await api.patch(`/user/${user._id}?field=billingInfo`, { billingInfo });
      setUser({ ...user, billingInfo });
